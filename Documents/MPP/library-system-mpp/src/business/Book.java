...
final public class Book implements Serializable {
	...
	public void addCopyOverDue() {
		copies[0].changeAvailability(); // make default one to unavailable
		BookCopy[] newArr = new BookCopy[copies.length + 1];
		System.arraycopy(copies, 0, newArr, 0, copies.length);
	...
	public boolean isAvailable() {
		...
		for (BookCopy bc : copies) {
			System.out.print("bc: " + bc.isAvailable());
		}
	...
	public String toString() {
		return "isbn: " + isbn + ", maxCheckoutLength: " + maxCheckoutLength + ", available: " + isAvailable();
	}
