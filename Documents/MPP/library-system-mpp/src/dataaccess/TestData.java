...
public class TestData {
	...
	public void libraryMemberData() {
		...
		LibraryMember libraryMemberOverDue = new LibraryMember("2000", "La", "Lazi", "641-223-2211", addresses.get(4), null);
		libraryMemberOverDue.checkOutBookOverDue(allBooks.get(4).getCopy(1));
		members.add(libraryMemberOverDue);
	...
	public List<Author> allAuthors = new ArrayList<Author>() {
		{
			...
			add(new Author("Measna", "Ly", "123-422-2664", addresses.get(3), "Life is simple."));
		}
	};
	...
	List<Book> allBooks = new ArrayList<Book>() {
		{
			...
			add(new Book("11-11111", "Hello Java", 7, Arrays.asList(allAuthors.get(5))));	
		}
	};
	...
	List<User> allUsers = new ArrayList<User>() {
		{
			add(new User("1001", "lib", Auth.LIBRARIAN));
			add(new User("1002", "admin", Auth.ADMIN));
			add(new User("1003", "both", Auth.BOTH));
		}
	};
}
